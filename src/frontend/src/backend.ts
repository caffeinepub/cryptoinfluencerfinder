...
export class Backend implements backendInterface {
    ...
    async fetchXApiRaw(arg0: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.fetchXApiRaw(arg0);
    ...
    async getSavedInfluencers(): Promise<Array<Influencer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSavedInfluencers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSearchHistory(): Promise<Array<SearchQuery>> {
        if (this.processError) {
            try {
    ...
    async getXApiTokenStatus(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getXApiTokenStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeInfluencer(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeInfluencer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveInfluencer(arg0: Influencer): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveInfluencer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSearchQuery(arg0: SearchQuery): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSearchQuery(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setXApiToken(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setXApiToken(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
